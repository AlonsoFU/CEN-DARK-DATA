#!/usr/bin/env python3
"""
Chapter 8 Extraction - Following UNIVERSAL_DOCLING_METHODOLOGY.md
"""
import json
import sys
...
OUTPUT_DIR = Path(__file__).parent / "capitulo_08" / "outputs"
OUTPUT_DIR.mkdir(parents=True, exist_ok=True)

print("=" * 80)
print(f"🔄 CHAPTER 8 EXTRACTION")
print("=" * 80)
print(f"Document: {DOCUMENT_NAME}")
print(f"PDF: {CHAPTER_PDF.name}")
print(f"Pages: 1 (single page chapter)")
print("=" * 80)
...
# Configure Docling (ACCURATE mode for tables)
...
print("\n" + "=" * 80)
print("✅ Chapter 8 extraction complete!")
