#!/usr/bin/env python3
"""
Create annotated PDF with ALL bounding boxes from Chapter 7 WITH PATCH
Uses layout_WITH_PATCH.json (with EAF monkey patch applied)
"""
import json
import fitz  # PyMuPDF
...
# Paths - using extraction WITH PATCH
json_path = Path(__file__).parent / "capitulo_07/outputs/layout_WITH_PATCH.json"
...
output_pdf = Path(__file__).parent / "capitulo_07/outputs/chapter7_WITH_PATCH.pdf"

print("\n" + "█" * 80)
print("🎨 CREATING COMPLETE ANNOTATED PDF FOR CHAPTER 7 (WITH PATCH)")
print("█" * 80)
...
for element in elements:
    ...
    # Calculate PDF page index (1-based to 0-based)
    ...
    # Draw rectangle
    # Coordinates already converted by to_top_left_origin() in extraction
...
print("=" * 80)
print("✅ COMPLETE ANNOTATED PDF CREATED (WITH PATCH)")
print("=" * 80)
print()
print(f"📁 Output file:")
print(f"   {output_pdf}")
...
print()
print("📋 What the patch included:")
print("   🔗 Complete titles (merged from PyMuPDF)")
print("   ✅ Missing titles detected")
print("   ⚡ Power system list items classified")
print("   🔄 Zona items properly classified (sequential vs isolated)")
print()
print("📄 Open the PDF to see ALL bounding boxes with EAF patch applied!")
print("=" * 80)
